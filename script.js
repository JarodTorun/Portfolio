...
if (skipIntro) {
  ...
  if (!isSlowConnection()) {
    ...
    // canplay, pas canplaythrough (voir /projets/ script.js, setupHero,
    // pour le détail) : canplaythrough ne se déclenche quasiment jamais sur
    // Safari iOS (bug WebKit connu, testé sur un vrai iPhone) - la vidéo
